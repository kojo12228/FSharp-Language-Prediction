...
The approximation used a rank 20 singular value matrix, then averaged the predicted values for each language for users that worked with/desired one language. Only IDs below 1000 were used. Included in the [results](/results) directory are the CSVs for worked with languages and desired next year languages.
...
![Worked With Results](results/worked_with_chart.png)
...
![Desired to Work With Results](results/desired_next_chart.png)
